...
class System {
  public:
    ...
    /** Sets the general debug flag
     *
     *  @param val The boolean value for the debug flag
     */
    void set_debug(bool val) { DEBUG_ = val; }

    /** Sets the general debug_output flag
	 *
	 *  @param val The boolean value for the debug_output flag
	 */
    void set_debug_output(bool val) { DEBUG_UPDATE_ = val; }
