...
class Interaction_System : public System {
 public:
    ...
    typedef void (*pickInteractionFunction)(Interaction_System*,Entity*, Entity*);
    
    
	virtual ~Interaction_System();
    ...
    void register_pick_interaction_function(pickInteractionFunction);
  ...
  private:
    ...
    pickInteractionFunction pick_interaction_function_;
    
    bool do_collide(Entity* ent1, Entity* ent2);
    virtual void pick_interaction(Entity* ent1, Entity* ent2);
