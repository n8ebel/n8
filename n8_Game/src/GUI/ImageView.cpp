...
gui::ImageView::ImageView(n8::Window* p_window, std::string p_id, n8::Texture* p_texture, int p_x, int p_y, int p_w, int p_h) : gui::GUIElement(p_window, p_id, p_x, p_y, p_w, p_h){
    m_texture = p_texture;
}
